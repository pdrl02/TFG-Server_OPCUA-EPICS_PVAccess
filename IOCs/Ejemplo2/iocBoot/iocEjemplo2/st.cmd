...
# Configura el IOC
epicsEnvSet("IOC", "Ejemplo2")
epicsEnvSet("TOP", "$(PWD)/Ejemplo2")
...
dbLoadDatabase("$(DBD)/Ejemplo2.dbd")

# Registrar los controladores de dispositivos
Ejemplo2_registerRecordDeviceDriver(pdbbase)

# Cargar los registros desde PVDatabase.db
dbLoadRecords("$(TOP)/Ejemplo2App/Db/PVDatabase.db")
